"""
Creates and saves a histogram of the normalized sum of squares of weights for dimensions of the trained decoder.

Also includes som code that calculates the cumulative frequencies (for ss and max value).
