...
%wat betekent "efficiently find the likelihood function?"
...
\cite{kingma2013auto} derive an analytical expression for KLD, which we also use in our implementation as this reduces noise and computation time. %hier nog iets van: "we can now perform stochastic gradient ascent on the lower bound" of zo?
