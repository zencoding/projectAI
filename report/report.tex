...
We can now form Monte Carlo estimates of expectations of some function f(z) with respect to $q_\phi(z|x)$. Yielding the following expression for the lower bound:
