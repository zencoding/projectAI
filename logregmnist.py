...
print 'percentage of training set correct: ',  calculate_percentage(h_train,t_train,w,b)
print 'percentage of test set correct: ', calculate_percentage(h_test,t_test,w,b)
